...
(function (global) {
  ...
  const CONFIG = {
    ...
    fsafe_cuke_preop: {
      sheets: [],
      supabase: {
        table: 'fsafe_gh_preop_v', orderBy: 'Checked Date', tiebreak: 'Checked Date',
        filters: { org_id: 'hawaii_farming', farm_key: 'cuke' },
        select: '"Checked Date","Approved to Harvest","Greenhouse(s)"',
        columns: [
          { label: 'Checked Date',        field: 'Checked Date',        type: 'date'    },
          { label: 'Approved to Harvest', field: 'Approved to Harvest', type: 'string'  },
          // Greenhouse(s) list (e.g. "bip_hi+bip_hk+jtl_01") drives the
          // expected GH count for the cuke check.
          { label: 'Greenhouse(s)',       field: 'Greenhouse(s)',       type: 'string'  },
        ],
      },
    },
    fsafe_lettuce_preop: {
      ...
      supabase: {
        table: 'fsafe_gh_preop_v', orderBy: 'Checked Date', tiebreak: 'Checked Date',
        filters: { org_id: 'hawaii_farming', farm_key: 'lettuce' },
        select: '"Checked Date","Approved to Harvest"',
        columns: [
          { label: 'Checked Date',        field: 'Checked Date',        type: 'date'    },
          { label: 'Approved to Harvest', field: 'Approved to Harvest', type: 'string'  },
        ],
