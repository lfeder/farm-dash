...
(function (global) {
  ...
  const CONFIG = {
    ...
    // Forward + current cycles (Planned / OnPond - Growing). Cols: B=pond C=side
    // D=variety E=seedname J=boardsperpond K=seedingdate M=expectedharvestdate
    // N=harvestdate AC=cyclestatus.
    lettuce_schedule: {
      sheets: [
        { sheetId: SHEETS.grow, tab: 'grow_L_seeding',
          tq: "select B,C,D,E,J,K,M,N,AC where AC = 'Planned' or AC = 'OnPond - Growing'",
          label_map: {
            pond: 'Pond', side: 'Side', variety: 'Variety', seedname: 'SeedName',
            boardsperpond: 'Boards', seedingdate: 'SeedingDate',
            expectedharvestdate: 'ExpHarvestDate', harvestdate: 'HarvestDate',
            cyclestatus: 'Status',
          } },
      ],
    },
