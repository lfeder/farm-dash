...
(function (global) {
  ...
  const CONFIG = {
    ...
    // 2026 cycles: planned, growing, and harvested (for historical look-back).
    // Cols: B=pond C=side
    ...
    lettuce_schedule: {
      sheets: [
        { sheetId: SHEETS.grow, tab: 'grow_L_seeding',
          tq: "select B,C,D,E,I,J,K,L,M,N,AC where (AC = 'Planned' or AC = 'OnPond - Growing' or AC = 'Harvested' or AC is null) and (YEAR(K)=2026 or YEAR(M)=2026 or YEAR(N)=2026)",
          label_map: {
