...
(function (global) {
  ...
  const CONFIG = {
    ...
    hr_payroll: {
      ...
      supabase: {
        table: 'hr_payroll',
        select: 'id,check_date,pay_period_start,pay_period_end,wc,hr_employee_id,employee_name,hr_department_id,hr_work_authorization_id,overtime_pay,overtime_hours,hourly_rate,per_diem,auto_allowance,other_pay,gross_wage,workers_compensation,tdi,payroll_processor,is_deleted',
        columns: [
          ...
          { label: 'WCcharged',   field: 'workers_compensation',      type: 'number'  },
          { label: 'TDIcharged',  field: 'tdi',                       type: 'number'  },
